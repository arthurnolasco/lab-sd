...
-- Q	=>  Location: PIN_E12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- clock	=>  Location: PIN_D12,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- Equation(s):
-- \Q~0_combout\ = (\enable~combout\ & (\D~combout\)) # (!\enable~combout\ & ((\Q~reg0_regout\)))
